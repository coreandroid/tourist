...
$Data['Contact'] ="";
 ...
 $Data['Image'] ="";
   ...
   $result = mysqli_query($conn,"select * from restaurants where Id=$_GET[Id]");
  ...
  move_uploaded_file($_FILES["image"]["tmp_name"],'images/'.$_FILES["image"]["name"]);
     ...
     if(intval($_POST['Id']) > 0){ // if hash id then update
      ...
      $stmt = $conn->prepare("UPDATE restaurants set `Name`=?,`OpenTime`=?,`CloseTime`=?,`MinimumSpend`=?,`Location`=?,`Contact`=?,`Description`=?,`Website`=?,`Image`=? where Id=?");
 ...
 echo "<script>alert('Restaurant is Updated');window.location.assign('restaurant.php');</script>";
     }else { //if not then add

     $stmt = $conn->prepare("INSERT INTO restaurants (`Name`, `OpenTime`, `CloseTime`, `MinimumSpend`, `Location`, `Contact`, `Description`, `Website`,`Image`) VALUES (?, ?, ?,?,?,?,?,?,?)");
   ...
   echo "<script>alert('Restaurant is Added');window.location.assign('restaurant.php');</script>";
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="purple">
                                    ...
                                    <p class="category">Edit or Create Restaurant</p>
                                </div>
                                <div class="card-content">
                                    <form method="POST" enctype="multipart/form-data">
                                     ...
                                     <?php if(strlen($Data['Location']) > 0){ ?>
                                        ...
                                        <input type="submit" class="btn btn-primary pull-right" name="save" value="Save Restaurant">
